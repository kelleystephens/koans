...
class AboutIteration < Neo::Koan
  ...
  def test_inject_will_blow_your_mind
    ...
    # inject takes the number in (), or the 1st num in array if none given, and
    # is the 2nd operator along with each item in arr. the new total becomes the new 2nd value
  end
